const args = process.argv; //returns an array containing the command line arguments: https://nodejs.org/docs/latest/api/process.html#process_process_argv
/*
args[0] - node location
args[1] - this file location
args[2] - [File extension] 
args[3] - [TEXT for searching]
 */
...
if(args.length==2 || args.length==3 || args.length>4) {
    console.log('USAGE: node search [File Extension] [TEXT for searching]');
}
else {
    ext = args[2];
    text = args[3];
